...
`phionyx-eval-inspect` is an Inspect AI bridge that exports Phionyx runtime-evidence records into Inspect eval logs. It is **alpha / experimental** software. Its value depends on its
...
**founder@phionyx.ai** with `[SECURITY] phionyx-eval-inspect` in the subject. Please do not open a public
issue or PR for a suspected vulnerability until it has been triaged.

Include, where you can: the version (`pip show phionyx-eval-inspect`), a minimal reproduction, and what
